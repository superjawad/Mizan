...
//  Procedural generator for an authentic Moroccan Salon (Seddari).
// =============================================================================
...
export class MoroccanSalonGenerator {
  ...
  _buildMaterials() {
    ...
    const materials = {
      ...
      edge:       new THREE.LineBasicMaterial({ color: m.edgeColor, transparent: true, opacity: 0 }),
  ...
  createLehhaf(length) {
    ...
    const mesh = new THREE.Mesh(
      ...
      this._getTiledMaterial('upholstery', length, cfg.seatDepth)
    );
  ...
  createMkhady(span) {
    ...
    for (let i = 0; i < cushionCount; i++) {
      const cushion = new THREE.Mesh(
        ...
        this._getTiledMaterial('upholstery', visibleWidth * 1.5, cush.height * 1.5)
      );
  ...
  createMida() {
    ...
    const top = new THREE.Mesh(new THREE.CylinderGeometry(spec.radius, spec.radius, spec.topThickness, 40), this._getTiledMaterial('wood', 2, 2));
    ...
    const foot = new THREE.Mesh(new THREE.CylinderGeometry(footRadius * 0.9, footRadius, spec.footThickness, 28), this._getTiledMaterial('wood', 1, 1));
